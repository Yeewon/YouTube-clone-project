export const miniSidebarTemplate = () => {
  return `
    ...
    <div class="mini-sidebar-item sidebar-home">
    ...
    <div class="mini-sidebar-item sidebar-search">
        <div class="sidebar-icon">
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon">
                <g class="style-scope yt-icon">
                    <path
    ...
    <div class="mini-sidebar-item sidebar-subscribe">
        <div class="sidebar-icon">
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon">
                <g class="style-scope yt-icon">
    ...
    <div class="mini-sidebar-item sidebar-storage">
        <div class="sidebar-icon">
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon">
                <g class="style-scope yt-icon">
...
<div class="sidebar-video-section">
  ...
  <div class="sidebar-to-watch-video">
      <div class="sidebar-icon">
          <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon"
              style="pointer-events: none; width: 100%; height: 100%;">
              <g class="style-scope yt-icon">
...
<div class="sidebar-subscribe-section">
  <p class="section-title">구독</p>
  <div class="sidebar-subscribe-item">예원</div>
  <div class="sidebar-subscribe-item">나영</div>
  <div class="sidebar-subscribe-item">지수</div>
  <div class="sidebar-subscribe-item">원영</div>
  <div class="sidebar-subscribe-item">윤서</div>
</div>
<div class="sidebar-youtube-more-section">
  <p class="section-title" >YOUTUBE 더보기</p>
  <div class="sidebar-youtube-premium">
      <div class="sidebar-icon">
          <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon"
              style="pointer-events: none; width: 100%; height: 100%;">
              <g class="style-scope yt-icon">
...
<div class="sidebar-guide-section">
  ...
  <div class="sidebar-customer-center">
      <div class="sidebar-icon">
          <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon"
              style="pointer-events: none; width: 100%; height: 100%;">
              <g class="style-scope yt-icon">
  ...
  <div class="sidebar-send-opinion">
      <div class="sidebar-icon">
          <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon"
              style="pointer-events: none; width: 100%; height: 100%;">
              <g class="style-scope yt-icon">
